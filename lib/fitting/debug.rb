    ...
    def self.save!(docs, yaml)
      ...
      yaml['Debug'].map do |action|
          ...
          combinations.push(
            {
              ...
              "index_before" => next_step.index_before - 7,
              "index_after" => next_step.index_after - 7,
        ...
        res_debug = {
          ...
          "index_before" => res.next_steps.first.index_before - 7,
          "index_after" => res.next_steps.first.index_after - 7,
